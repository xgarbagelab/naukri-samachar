...
<!--            <nav class="white ">
                <div class="nav-wrapper">
                    <a href="#!" class="brand-logo">
                        <img src="images/naukri_samachar_new_3.png" width="150" class="responsive-img">
                    </a>
                  <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
                  <ul class=" hide-on-med-and-down top-nav ">
                    <li class="blue"><a class="blue" href="sass.html">HOME</a></li>
                    <li class="orange"><a class="orange" href="badges.html">JOB PORTAL</a></li>
                    <li class="yellow"><a class="yellow" href="collapsible.html">COURSE PORTAL</a></li>
                    <li class="green"><a  class="green" href="mobile.html">CONTACT US</a></li>
                    <li class="red"><a  class="red" href="mobile.html">LOG-IN</a></li>
